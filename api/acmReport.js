export function thisYearOrMonthDiary(post,dataType){
	//month月 year年 
	return post('/v1/acmReport/thisYearOrMonthDiary/query',{dataType:dataType})
}
 ...
 */
export function cashInOutTopFive(post,dataType){
    return post('/v1/acmReport/CashInOutTopFive/query',{dataType:dataType})
}
...
export function queryDeskTopInitDate(post,paymentsType,dataType){
    paymentsType = paymentsType ? paymentsType : 'out'
    dataType = dataType?dataType:'month'
    return post('/v1/acmReport/queryDeskTopInitDate',{paymentstype:paymentsType,dataType:dataType})
}
//代账端初始化
