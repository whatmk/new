...
export function assetDetailRptPrint(post,startYear,startMonth,endYear,endMonth,containNoDepreciation,assetName, assetTypeId,assetClassId){
    return post('/v1/assetDetailRpt/print',{startYear,startMonth,endYear,endMonth,containNoDepreciation,assetName, assetTypeId,assetClassId})
}
export function assetDetailRptExport(post,startYear,startMonth,endYear,endMonth,containNoDepreciation,assetName, assetTypeId,assetClassId){
    return post('/v1/assetDetailRpt/export',{startYear,startMonth,endYear,endMonth,containNoDepreciation,assetName, assetTypeId,assetClassId})
}
...
export function exportDisposeDetaileList(post, assetTypeId, assetReduceTypeid, beginDate, endDate,id) {
    return post('/v1/fiAsset/exportDisposeDetaileList',{assetTypeId, assetReduceTypeid, beginDate, endDate,id})
}
export function printDepreciationList(post, period) {
    return post('/v1/fiAsset/printDepreciationList',{period})
}
export function pirntDisposeDetaileList(post, assetTypeId, assetReduceTypeid, beginDate, endDate,id) {
    return post('/v1/fiAsset/pirntDisposeDetaileList',{assetTypeId, assetReduceTypeid, beginDate, endDate,id})
}
//资产处置，处置方式初始化，获取下拉项
