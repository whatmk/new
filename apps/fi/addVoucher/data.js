export function getMeta() {
	return {
		name: 'root',
		component: 'Layout',
		className: 'edfx-app-proof-of-charge',
		onMouseDown: '{{$mousedown}}',
		children: [{
			name: 'header',
			component: 'Layout',
			className: 'edfx-app-proof-of-charge-header',
			children: [{
				name: 'left',
				component: 'Layout',
				className: 'edfx-app-proof-of-charge-header-left',
				children: [{
					name: 'page',
				...
				name: 'right',
				component: 'Layout',
				className: 'edfx-app-proof-of-charge-header-right',
				children: [{
					name: 'save',
					component: 'Button',
					type: 'showy',
			...
			name: 'title',
			component: 'Layout',
			className: 'edfx-app-proof-of-charge-title',
			children: [{
				name: 'left',
				component: 'Layout',
				className: 'edfx-app-proof-of-charge-title-left',
				children: [{
					name: 'audited',
					component: '::div',
					className: 'edfx-app-proof-of-charge-title-left-tag',
					children: '已审核',
				...
				name: 'center',
				component: '::div',
				className: 'edfx-app-proof-of-charge-title-center',
				children: {
					name: 'title',
					component: '::h1',
					children: '记账凭证'
				...
				name: 'right',
				component: 'Layout',
				className: 'edfx-app-proof-of-charge-title-right',
			}]
		}, {
			name: 'formHeader',
			component: 'Layout',
			className: 'edfx-app-proof-of-charge-form-header',
			children: [{
				name: 'code',
				component: 'Layout',
				className: 'edfx-app-proof-of-charge-form-header-code',
				children: ['计字第',{
					name: 'code',
					component: 'Input',
				...
				name: 'date',
				component: 'Layout',
				className: 'edfx-app-proof-of-charge-form-header-date',
				children: ['日期',{
					name: 'date',
				...
				name: 'attachment',
				component: 'Layout',
				className: 'edfx-app-proof-of-charge-form-header-attachment',
				children: ['附件数',{
					name: 'attachment',
			...
			name: 'details',
			component: 'DataGrid',
			className: 'edfx-app-proof-of-charge-form-details',
			headerHeight: 45,
			rowHeight: 45,
			footerHeight: 45,
			...
			columns: [{
				...
				cell: {
					name: 'cell',
					component: "{{$isFocus(_ctrlPath) ? 'Select' : 'DataGrid.TextCell'}}",
					className: "{{$getCellClassName(_ctrlPath) + ' edfx-app-proof-of-charge-form-details-captionOfAccount'}}",
					showArrow:false,
					suffix:{
						name: 'link',
						component: '::a',
			...
			name: 'footer',
			component: 'Layout',
			className: 'edfx-app-proof-of-charge-footer',
			children: [{
				name: 'creator',
				component: '::h3',
				children: '制单人:张三',
