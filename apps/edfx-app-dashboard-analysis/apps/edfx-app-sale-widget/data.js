export function getMeta() {
	return {
		name: 'root',
		component: 'Layout',
		className: 'edfx-app-sale-widget',
		children: [{
			name: 'header',
			component: 'Layout',
			className: 'edfx-app-sale-widget-header',
			children: [{
				name: 'left',
				component: '::span',
				children: '总销售额'
			...
			name: 'text',
			component: '::p',
			className: 'edfx-app-sale-widget-text',
			children: "{{'¥  ' + $numberFormat(data.total)}}"
		}, {
			name: 'rate',
			component: 'Layout',
			className: 'edfx-app-sale-widget-rate',
			...
			name: 'footer',
			component: 'Layout',
			className: 'edfx-app-sale-widget-footer',
			children: [{
				name: 'label',
				component: '::span',
				children: '日均销售额'
