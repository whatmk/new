export function getMeta() {
	return {
		name: 'root',
		component: 'Layout',
		className: 'edfx-app-hot-search-widget',
		children: [{
			name: 'top',
			component: 'Layout',
			...
			children: [{
				name: 'left',
				component: 'Layout',
				className: 'edfx-app-hot-search-widget-top-left',
				children: [{
					name: 'title',
					component: '::span',
					children: '搜索用户数'
				...
				name: 'right',
				component: 'Layout',
				className: 'edfx-app-hot-search-widget-top-right',
				children: [{
					name: 'title',
					component: '::span',
					children: '搜索次数'
			...
			name: 'bottom',
			component: 'Layout',
			className: 'edfx-app-hot-search-widget-bottom',
			children: [{
				name: 'dataGrid',
				component: 'DataGrid',
				headerHeight: 35,
